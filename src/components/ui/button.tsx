...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-[var(--text-primary)] text-[var(--bg-primary)] hover:opacity-85",
        destructive:
          "bg-[var(--risk-high)] text-white hover:opacity-90",
        outline:
          "border border-[var(--border-subtle)] bg-transparent hover:bg-muted/30 text-[var(--text-primary)]",
        secondary:
          "border border-[var(--border-subtle)] bg-transparent hover:bg-muted/30 text-[var(--text-primary)]",
        ghost: "text-[var(--text-muted)] hover:underline hover:text-[var(--text-primary)]",
